...
async function testPayment(param) {
    var hashSha1 =  CryptoJS.SHA1(param.CLIENT_CODE+param.GUID+param.SanalPOS_ID+param.Taksit+param.Islem_Tutar+param.Toplam_Tutar+param.Siparis_ID+param.Hata_URL+param.Basarili_URL);
var Islem_Hash = CryptoJS.enc.Base64.stringify(hashSha1);
    ...
    `<soap:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">\
     ...
     <SanalPOS_ID>${param.SanalPOS_ID}</SanalPOS_ID>\
  ...
  try {
    const response = await axios(`https://test-dmz.param.com.tr:4443/turkpos.ws/service_turkpos_test.asmx`,config);
