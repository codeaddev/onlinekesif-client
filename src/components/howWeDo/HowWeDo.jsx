  ...
  return (
    <div className="section how-works">
      ...
      <div className="top">
        ...
        <div className="right">
          <label>
            2<img src={Label2} alt="label" />
          </label>

          <h5>Fiyat Teklifi Alın</h5>
          <p>
            İhtiyaç duyduğunuz hizmeti veren firmaların size özel sunduğu
      ...
      <div className="bottom">
        <div className="left">
          <label>
            3<img src={Label3} alt="label" />
          </label>

          <h5>Firma İle Anlaşın</h5>
          <p>
            Size en uygun gelen teklifi kabul ederek firma ile iletişime
            geçebilir
          </p>
        </div>
        <div className="right">
          <label>
            4<img src={Label4} alt="label" />
          </label>

          <h5>Sonuca Ulaşın</h5>
          <p>
            Online Keşif sayesinde ihtiyaç duyduğunuz çözüme ulaşabilirsiniz.
          </p>
        </div>
      </div>
    </div>
