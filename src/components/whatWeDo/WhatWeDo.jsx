    ...
    <div className="section we-do">
      ...
      <div className="top">
        ...
        <div className="right">
          <div className="text-box">
            <p>
              Yaşam alanlarınız için ihtiyaç duyduğunuz hizmetin tüm
              özelliklerini birlikte belirleyelim.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bottom">
        <div className="left">
          <div className="text-box">
            <p>
              İhtiyacınız doğrultusunda size hizmet verecek en uygun firmayı
              seçmenize yardımcı olalım.
            </p>
          </div>
        </div>
        <div className="right">
