  ...
  return (
    <div className="btn-wrapper">
      ...
      >
        ...
        {counter ? <div className="notify-circle"></div> : null}
      </div>
      <div className={`chatBox ${className}`}>
        <div className="finish-chat" onClick={handleFinish}>
          <button>
            <SouthEastIcon />
          </button>
        </div>
        <div className="chatcontainer">
          <div className="chat-top">
            ...
            <div className="chat-top-right">Canlı Destek</div>
          </div>
          ...
          <div className="chat-bottom">
            <form onSubmit={handleSubmit}>
              ...
              <div className="addFile">
                <label htmlFor="img">
                  <img src={Attach} style={{ cursor: "pointer" }} alt="" />
                </label>
                <input
                  onChange={(e) => {
