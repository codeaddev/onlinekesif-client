  ...
  return (
    <div className="last-page">
        ...
        <div className="input-area">
          <div className="top">
            <textarea
              ...
              onChange={(e) => {
                setWishDetail({
                  ...wishDetail,
                  [ekstra]: { id: "1111", q: ekstra, a: e.target.value },
                });
              }}
            ...
            <textarea
              placeholder="Adres"
              onChange={(e) =>
                setBasicInfo({ ...basicInfo, adress: e.target.value })
              }
          ...
          <div className="bottom">
            {user && !auth.currentUser.isAnonymous ? (
              <button className="send-button" onClick={handleSubmitDirect}>
                Gönder
              </button>
            ) : (
              <>
                <div className="auth-type-area">
                  ...
                  <div
                    className={`auth-type-button hidden ${
                      willReg ? `left` : `right`
                    }`}
                  ></div>
                  <label
                  ...
                  {willReg ? (
                    <>
                      <input
                        ...
                        name="email"
                        onChange={(e) => {
                          setPopUpRegMail(e.target.value);
                    ...
                    <>
                      ...
                      <input
                        ...
                        type="password"
                      />
                      <button onClick={handleSubmitWithLogin}>
      ...
      <button
        ...
        onClick={(e) => {
          e.preventDefault();
          var newPercent = questionData.percent.slice(
            0,
