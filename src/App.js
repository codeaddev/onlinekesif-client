  ...
  return loading === true ? (
    ...
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route
          path="Web-Sitesi-Gizlilik-Ve-Cerz-Politikasi"
          element={<WsgzpPage />}
        />
        <Route
          path="site-haritasi"
        ...
        <Route
          path="hizmetler"
          element={<Services setMainList={setMainList} mainList={mainList} />}
        />
        <Route path="/">
          <Route
            index
          ...
          {!!user && !user.isAnonymous ? (
            <Route path="profil">
              <Route index element={<Profile setMainList={setMainList} />} />
              <Route path="hesabim" element={<MyAccount />} />
              <Route path="ayarlar" element={<Settings />} />
              <Route path="kesiflerim">
                <Route
                  index
                  element={<Kesiflerim setMainList={setMainList} />}
                />
      ...
      <div className={showButton ? "showScrollButton" : "hiddenScrollButton"}>
        <IconButton>
          <KeyboardArrowUpIcon
      ...
      >
        ...
        Sitemizin doğru çalışmasını sağlamak, sosyal medya özelliklerini
        sunabilmek, site trafiğimizi analiz etmek, reklamları ve içerikleri
        kişiselleştirmek için &nbsp;
        <a href="https://onlinekesif.com/Web-Sitesi-Gizlilik-Ve-Cerz-Politikasi">
          Çerez Politikası'ndan{" "}
        </a>
        &nbsp; yararlanıyoruz. Aynı zamanda site kullanımınızla ilgili
        bilgileri; reklamcılık, sosyal medya ve analiz ortaklarımızla
        paylaşıyoruz.
      </CookieConsent>
    </BrowserRouter>
  );
