...
const Services = ({ setMainList, mainList, scrollPosition, ...props }) => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  return (
    <div className="services">
      <h1>
        Sizin İçin <u className="underline">Ne Yapabiliriz?</u>
      </h1>
      {isloadingSlide ? (
        <h3>Loading...</h3>
      ) : (
      ...
      <div className="center-container">
        <div className="left">
          <img className="arrow" src={Curved} alt="success" />
          <h2>
            <u>Trend</u> Hizmetler
          </h2>
          <h3>
            Online Keşifte en çok tercih edilen hizmetlerden hemen yararlanın.
          </h3>
          <p>
            İhtiyacınız olan keşif talepleri arasında en çok tercih edilen
            hizmetlerden hızlı bir şekilde yararlanıp, dilediğiniz talepte
            bulunun. Online Keşif sayesinde artık ne zaman ihtiyacınız olursa
            olsun trend hizmetlerimizden yararlanıp isteğinize uygun keşfi talep
            edebilirsiniz.
          </p>
