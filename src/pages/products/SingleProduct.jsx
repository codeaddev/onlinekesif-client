...
useEffect(()=>{
  ...
  return () => {
    ...
    const handleLike=async(e)=>{
        e.preventDefault()
        await updateDoc(doc(db,"Products",item.id),{likes:arrayUnion(
    ...
    const handleDisLike=async(e)=>{
        ...
        await updateDoc(doc(db,"Products",item.id),{likes:arrayRemove(
          myRow[0]
          )})
          await updateDoc(doc(db,"Users",auth.currentUser.uid),{
            point:arrayUnion({
    ...
    const handleComment=async(e)=>{
        ...
        await updateDoc(doc(db,"Products",item.id),{comments:arrayUnion(
          {id:new Date().valueOf().toString().substring(8),
          userid:auth.currentUser.uid,
