...
import { GoogleAuthProvider, signInWithEmailAndPassword, signInWithPopup,FacebookAuthProvider, createUserWithEmailAndPassword, updateProfile, sendEmailVerification, EmailAuthProvider, linkWithCredential } from "firebase/auth"
...
function Register() {
  ...
  const handleErrorMessage=(err)=>{
    if(err==="Firebase: Error (auth/email-already-exists)."){
      ...
      setAlertMessage("Bir hata meydana geldi, tekrar deneyin", err.message.replace("Firebase: Error ",""))
    }
  ...
  if(auth.currentUser?.isAnonymous){
    ...
    try{
      ...
      await setDoc(doc(db,"Users",createUser.user.uid),{
        ...
        likes:[],
        comments:[]
      }).catch((er)=>{handleErrorMessage(er.message)})
      getUserData()
      navigate("/")
        ...
        <div className="left">
          ...
          onSubmit={handleSubmit}>
              ...
              <div className='radios'>
                              ...
                              İleti almak istiyorum." checked={regData.letMeKnow} onClick={()=>{setRegData({...regData,letMeKnow:!regData.letMeKnow})}}/>
