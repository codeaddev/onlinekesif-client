...
import { BursaDistricts, BursaNeighbourhoods,Bursa } from '../../components/data/bursa/ditricts'
import { useNavigate } from 'react-router-dom'
import CreditCardForm from '../payment/CreditCardForm'
import { addDoc, collection } from 'firebase/firestore'
import { db } from '../../firebase/firebase.config'
import { CircularProgress } from '@mui/material'
import IbanEft from "../payment/IbanEft"
...
const JetServices = () => {
    useEffect(() => {
      ...
      const handleSubmit=async(e)=>{
        ...
        try {
            ...
            b= await emailjs.send('onlinekesif_support', 'template_fd5d0vb', params,"az39-SQ3JNFE4N2sA")
        ...
        try {
            ...
            c= await emailjs.send('onlinekesif_support', 'template_d0hbk7o', params,"az39-SQ3JNFE4N2sA")
            setSending(false)
    ...
    const handleSelectPaymentPos=(e,bool)=>{
        setInfo({...info,paymentType:e,paid:bool})
        navigate("/odeme")

    }
    const paymentTypes=[
        {id:"01",label:"EFT / HAVALE",onlinePos:false,paid:false,price:"600"},
        //{id:"02",label:"Kapıda Ödeme",onlinePos:false,paid:false},
        {id:"03",label:"Kapıda Kredi Kartı ile Ödeme",onlinePos:false,paid:false,price:"600"},
        {id:"04",label:"Hemen Öde",onlinePos:true,paid:false,price:"600"},
    ]
  return (
    <div className='jet-page-container'>
        <div className="jet-services-page">
            <h2 className='section-header-text small middle'><u>Kombi Temizliği</u> Yaptırmak İstiyorum</h2>
            {!sending?
            <form 
                    ...
                    <div className="choices">
                        {
                            paymentTypes.map(i=>{
                                return(
                                    ...
                                    className={`choice ${info?.paymentType===i.label?"selected":"non-selected"}`}
                                    key={i.id}>{i.label}</div>
                                )
                            })
                        }
